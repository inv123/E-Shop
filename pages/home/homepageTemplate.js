						...
						<div class="product-info">
							<div class="nav-main">
								...
								<ul class="nav nav-tabs" id="myTab" role="tablist" @click=${homepageInfo.setActiveTab}>
									<li class="nav-item"><a class="nav-link ${ifDefined(homepageInfo.currentTab === 'man' ? 'active' : '')}" data-toggle="tab" href="#man" role="tab">Man</a></li>
									<li class="nav-item"><a class="nav-link ${ifDefined(homepageInfo.currentTab === 'women' ? 'active' : '')}" data-toggle="tab" href="#women" role="tab">Woman</a></li>
									<li class="nav-item"><a class="nav-link ${ifDefined(homepageInfo.currentTab === 'kids' ? 'active' : '')}" data-toggle="tab" href="#kids" role="tab" >Kids</a></li>
									<li class="nav-item"><a class="nav-link ${ifDefined(homepageInfo.currentTab === 'accessories' ? 'active' : '')}" data-toggle="tab" href="#accessories" role="tab">Accessories</a></li>
									<li class="nav-item"><a class="nav-link ${ifDefined(homepageInfo.currentTab === 'essential' ? 'active' : '')}" data-toggle="tab" href="#essential" role="tab">Essential</a></li>
									<li class="nav-item"><a class="nav-link ${ifDefined(homepageInfo.currentTab === 'prices' ? 'active' : '')}" data-toggle="tab" href="#prices" role="tab">Prices</a></li>
								</ul>
								<!--/ End Tab Nav -->
							</div>
							<div class="tab-content" id="myTabContent">
								...
								<!--/ End Single Tab -->
								<!-- Start Single Tab -->
								<div class="tab-pane fade ${ifDefined(homepageInfo.currentTab === 'women' ? 'show active' : '')}" id="women" role="tabpanel">
									<div class="tab-single">
										<div class="row">
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
								...
								<!--/ End Single Tab -->
								<!-- Start Single Tab -->
								<div class="tab-pane fade ${ifDefined(homepageInfo.currentTab === 'prices' ? 'show active' : '')}" id="prices" role="tabpanel">
									<div class="tab-single">
										<div class="row">
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
